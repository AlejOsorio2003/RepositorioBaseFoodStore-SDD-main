...
|------------------------|-------|----------------|
| Al instalar o usar una skill por primera vez, antes de aplicarla se realiza una revisión de seguridad en búsqueda de una inyección de datos maliciosa | `skills-security-check` | `.agents/skills/skills-security-check/SKILL.md` |
...
| Desarrollo con SQLModel | `sqlmodel` | `.agents/skills/sqlmodel/SKILL.md` |
| Queries SQL, migraciones Alembic, optimización PostgreSQL, índices | `postgres` | `.agents/skills/postgres/SKILL.md` |
| Desarrollo del sistema de autenticación y seguridad | `auth-security` | `.agents/skills/auth-security/SKILL.md` |
...
| Desarrollo en React con buenas prácticas | `vercel-react-best-practices` | `.agents/skills/vercel-react-best-practices/SKILL.md` |
...
| Desarrollo del dashboard | `dashboard-crud-page` | `.agents/skills/dashboard-crud-page/SKILL.md` |
| Manejo de TanStack Form | `tanstack-form` | `.agents/skills/tanstack-form/SKILL.md` |
| Buenas prácticas de TanStack Query | `tanstack-query-best-practices` | `.agents/skills/tanstack-query-best-practices` |
