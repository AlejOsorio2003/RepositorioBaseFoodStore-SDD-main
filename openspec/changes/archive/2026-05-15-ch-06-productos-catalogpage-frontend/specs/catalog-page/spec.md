...
- **WHEN** el usuario navega a `/productos/1`
- **THEN** se renderiza `ProductoDetailPage` con el detalle del producto con id=1

#### Scenario: ID inválido muestra estado de error
- **WHEN** se navega a `/productos/9999` y el backend retorna 404
